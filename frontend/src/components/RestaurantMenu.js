  ...
  return (
    <React.Fragment>
      <AppBar position="relative">
        <Toolbar>
        <RouterLink RouterLink to={"/Restaurant/" + restId} style={{ color: "#FFF" }}>
      ...
      <main>
        ...
        <Container className={classes.cardGrid}>
          ...
          <Card className={classes.card}>
            ...
            <CardActions>
              {orders.length == 0 ?
                <Button variant="contained" color="primary" size="small" style={{ margin: 15 }} disabled={true}>
                  You have to select at least one position to proceede
                </Button>
                :
                <Button variant="contained" color="primary" size="small" style={{ margin: 15 }}>
                  <RouterLink to={{ pathname: "/NewOrder/Restaurant/" + restId, state: { orders } }} style={{ color: "#FFF" }}>
