                    ...
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12}>
                            <TextField
                                ...
                                onChange={handleChange}
                                onBlur={handleBlur}
                                error={errors["city"] === undefined ? false : errors["city"].length > 0}
                        ...
                        <TextField
                                ...
                                onChange={handleChange}
                                onBlur={handleBlur}
                                error={errors["street"] === undefined ? false : errors["street"].length > 0}
                        ...
                        <TextField
                                ...
                                onChange={handleChange}
                                onBlur={handleBlur}
                                error={errors["postCode"] === undefined ? false : errors["postCode"].length > 0}
